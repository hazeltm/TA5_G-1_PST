            ...
            case R.id.btnIngreso:
                ...
                if (!usuario.isEmpty() && !password.isEmpty()) {
                    ...
                    if (checkUsuarioPassword) {
                        ...
                        edtTxtPassword.setText("");
                        Toast.makeText(Login.this, "Contraseña incorrecta, intente de nuevo", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(Login.this, "Llenar los campos faltantes", Toast.LENGTH_SHORT).show();
                }
                break;
